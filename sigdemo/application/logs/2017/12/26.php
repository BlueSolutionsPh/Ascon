...
2017-12-26 18:08:02 --- ERROR: ErrorException [ 4 ]: syntax error, unexpected '"' ~ MODPATH/dev/views/dev.template.php [ 36 ]
2017-12-26 18:08:02 --- STRACE: ErrorException [ 4 ]: syntax error, unexpected '"' ~ MODPATH/dev/views/dev.template.php [ 36 ]
--
#0 [internal function]: Kohana_Core::shutdown_handler()
#1 {main}
2017-12-26 18:17:13 --- ERROR: Database_Exception [ 42P01 ]: SQLSTATE[42P01]: Undefined table: 7 ERROR:  relation "m_booth" does not exist
...
2017-12-26 18:17:13 --- STRACE: Database_Exception [ 42P01 ]: SQLSTATE[42P01]: Undefined table: 7 ERROR:  relation "m_booth" does not exist
LINE 1: ..._id) as cnt from ( select  m_booth.booth_id from  m_booth jo...
                                                             ^ [ select 	count(booth.booth_id) as cnt from ( select 	m_booth.booth_id from 	m_booth join 	m_client on 	m_booth.client_id = m_client.client_id and 	m_client.del_flag = 0 where 	m_booth.client_id = 1 and	m_booth.del_flag = 0 ) booth  ] ~ MODPATH/database/classes/kohana/database/pdo.php [ 157 ]
--
...
#9 {main}
2017-12-26 18:17:30 --- ERROR: Database_Exception [ 42P01 ]: SQLSTATE[42P01]: Undefined table: 7 ERROR:  relation "m_booth" does not exist
LINE 1: ..._id) as cnt from ( select  m_booth.booth_id from  m_booth jo...
                                                             ^ [ select 	count(booth.booth_id) as cnt from ( select 	m_booth.booth_id from 	m_booth join 	m_client on 	m_booth.client_id = m_client.client_id and 	m_client.del_flag = 0 where 	m_booth.client_id = 1 and	m_booth.del_flag = 0 ) booth  ] ~ MODPATH/database/classes/kohana/database/pdo.php [ 157 ]
2017-12-26 18:17:30 --- STRACE: Database_Exception [ 42P01 ]: SQLSTATE[42P01]: Undefined table: 7 ERROR:  relation "m_booth" does not exist
LINE 1: ..._id) as cnt from ( select  m_booth.booth_id from  m_booth jo...
                                                             ^ [ select 	count(booth.booth_id) as cnt from ( select 	m_booth.booth_id from 	m_booth join 	m_client on 	m_booth.client_id = m_client.client_id and 	m_client.del_flag = 0 where 	m_booth.client_id = 1 and	m_booth.del_flag = 0 ) booth  ] ~ MODPATH/database/classes/kohana/database/pdo.php [ 157 ]
--
#0 /var/www/html/simplesig/modules/database/classes/kohana/database/query.php(245): Kohana_Database_PDO->query(1, 'select ?count(b...', true, Array)
