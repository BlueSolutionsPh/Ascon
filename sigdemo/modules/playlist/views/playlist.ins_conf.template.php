...
<?php endforeach; ?>
          ...
          <div class="btn_area_02">
            <?php echo Form::button(NULL, "Return", array("id" => "playlist_ins_conf_back", 'class'=>'btn1 btn_l')) ?>
            <?php echo Form::button(NULL, "Confirmation", array("id" => "playlist_ins_conf_submit", "type" => "submit", 'class'=>'btn1 btn_r')) ?>
          </div>
        <?php echo Form::close() ?>
        <div class="clear"></div>
