    ...
    <div class="top_title">
      <div class="top_title_wrapper">
        <div class="top_title_inner clearfix"><div class="text">Program guide setting [Program list (repeated designation) update]</div>
          <div class="menu_link"><?php echo HTML::anchor("/" . MODULE_NAME_MENU, "To the menu", array("id" => "progrgl_up_conf_menu", "class" => "btn2"), null, false) ?></div>
        </div>
      </div>
    </div>
      ...
      <div class="box_01">
        ...
        <div class="content">
            ...
            <div class="btn_area_02">
              <?php echo Form::button(NULL, "Return", array("id" => "progrgl_up_conf_back", "type" => "submit", 'class'=>'btn1 btn_l', 'onclick'=>'$("#act").val("back")')) ?>
              <?php echo Form::button(NULL, "Confirmation", array("id" => "progrgl_up_conf_submit", "type" => "submit", 'class'=>'btn1 btn_r')) ?>
            </div>
          <?php echo Form::close() ?>
          <div class="clear"></div>
