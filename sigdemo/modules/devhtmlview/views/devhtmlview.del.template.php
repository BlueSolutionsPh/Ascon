    <div class="top_title">
      <div class="top_title_wrapper">
        <div class="top_title_inner clearfix">
          <div class="text">Smartphone distribution setting by terminal [Delete smartphone delivery]</div>
          <div class="menu_link"><?php echo HTML::anchor("/" . MODULE_NAME_MENU, "To the menu", array("id" => "devhtmlview_del_menu", "class" => "btn2"), null, false) ?></div>
        </div>
      </div>
    </div>
      ...
      <div class="box_01">
        ...
        <div class="content">
          ...
          <div class="btn_area_02">
            <?php echo(HTML::anchor($url, "Return", array("id" => "devhtmlview_del_back", "class" => "btn1 btn_l"), null, false))?>
            <?php echo Form::button(NULL, "Delete", array("id" => "devhtmlview_del_submit", "type" => "submit", 'class'=>'btn1 btn_r')) ?>
          </div>
          <div class="clear"></div>
          <?php echo Form::close() ?>
