        ...
        <div class="content">
          ...
          <?php echo Form::hidden("act", "ins") ?>
            ...
            <div class="btn_area_02">
              <?php echo Form::button(NULL, "Return", array("id" => "authgrp_ins_conf_back", "type" => "submit", 'class'=>'btn1 btn_l', 'onclick'=>"$('input[name=act]').val('back')")) ?>
              <?php echo Form::button(NULL, "Confirmation", array("id" => "authgrp_ins_conf_submit", "type" => "submit", 'class'=>'btn1 btn_r')) ?>
            </div>
          <?php echo Form::close() ?>
          <div class="clear"></div>
        </div>
