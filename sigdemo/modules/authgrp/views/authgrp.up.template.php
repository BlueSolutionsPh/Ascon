          ...
          <?php echo Form::hidden("auth_grp_id", $post["auth_grp_id"]) ?>
            ...
            <div class="hr_wrapper_01">
              <dl class="dl_input_02">
                ...
                <dd>
                  <?php echo Form::input("auth_grp_name", HTML::replace_empty_array_value($post, "auth_grp_name"), array("id" => "authgrp_up_auth_grp_name", "required" => "true", "maxlength" => "20", "class" => "input250")) ?>
                  ※ Within 20 characters
                </dd>

                <dt>Authority management</dt>
                <dd>
                  <div style="margin:5px;"><?php echo Form::button("btn_all", "Check all", array("id" => "authgrp_up_btn_all", "type" => "button", "class" => "btn6", "onclick" => "func_chk_all_btn(this)")) ?></div>
                        ...
                        <?php if($i > 0): ?><br /><?php endif ?>
                          <?php foreach($arr_module as $module): ?>
                            <div style="margin:5px 10px 5px 15px; padding-right:10px;">
                              <div style="float:left"><?php echo Form::button("btn_" . $module["module"], $module["module_name"], array("id" => "authgrp_up_btn_" . $module["module"], "type" => "button", "style" => "width:170px;margin-right:10px;", "class" => "btn6", "onclick" => "func_chk_btn(this)")) ?></div>
                              <?php $j = 1 ?>
                              <?php foreach($module["arr_auth"] as $auth): ?>
                                ...
                                <div style="width:100px;margin:5px 0 5px 10px;float:left;">
                                  <?php echo Form::checkbox("arr_auth[]", $auth["auth_id"], in_array($auth["auth_id"], HTML::replace_empty_array_value($post, "arr_auth", array())), array("id" => "authgrp_up_auth_" . $auth["auth_id"])) ?>
            ...
            <div class="btn_area_02">
              <?php echo HTML::anchor("/" . MODULE_NAME_AUTHGRP, "Return", array("id" => "authgrp_up_back", "class" => "btn1 btn_l"), null, false) ?>
              <?php echo Form::button(NULL, "update", array("id" => "authgrp_up_submit", "type" => "submit", 'class'=>'btn1 btn_r')) ?>
            </div>
          <?php echo Form::close() ?>
          <div class="clear"></div>
        </div>
