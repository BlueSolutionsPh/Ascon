      ...
      <div class="box_01">
        ...
        <div class="content">
          ...
          <div class="btn_area_02">
            <?php echo Form::button(NULL, "Return", array("id" => "commonplaylist_up_conf_back", 'class'=>'btn1 btn_l')) ?>
            <?php echo Form::button(NULL, "Confirmation", array("id" => "commonplaylist_up_conf_submit", "type" => "submit", 'class'=>'btn1 btn_r')) ?>
          </div>
        <?php echo Form::close() ?>
        <div class="clear"></div>
