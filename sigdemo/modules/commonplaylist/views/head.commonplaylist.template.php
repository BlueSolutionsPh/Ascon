...
function func_page_search(page){
	var frm_obj = document.getElementById("commonplaylist_search_form");
...
function On_BoxChecked(){
	for(var i=0; i<=arguments.length-1; i++) {
		...
		document.getElementById("commonplaylist_lumpdel").disabled=false;
	}
}
function Off_BoxChecked(){
	for(var i=0; i<=arguments.length-1; i++) {
		document.getElementById("chk_"+arguments[i]).checked=false;
		document.getElementById("commonplaylist_lumpdel").disabled=true;
	}
}
