    ...
    <div class="top_title">
      <div class="top_title_wrapper">
        <div class="top_title_inner clearfix">
          <div class="text">Content setting [Delete all common telop]</div>
          <div class="menu_link"><?php echo HTML::anchor("/" . MODULE_NAME_MENU, "To the menu", array("id" => "commontext_del_menu", "class" => "btn2"), null, false) ?></div>
        </div>
      </div>
    </div>
    ...
    <div id="main">
      ...
      <div class="box_01">
        <h3 class="title">Delete all common telop</h3>
        <div class="content">
        ...
        <?php } ?>
          ...
          <div class="btn_area_02">
            <?php echo HTML::anchor("/" . MODULE_NAME_COMMONTEXT, "Return", array("id" => "commontext_del_back", "class" => "btn1 btn_l"), null, false) ?>
            <?php echo Form::button(NULL, "Delete", array("id" => "commontext_del_submit", "type" => "submit", 'class'=>'btn1 btn_r')) ?>
          </div>
          <div class="clear"></div>
        <?php echo Form::close() ?>
